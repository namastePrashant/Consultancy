        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($interviewForm->isValid($formData)) {
                ...
                try {
                    ...
                    $this->_helper->FlashMessenger->addMessage(array("error" => "It seems like this candidate has already taken the interview."));
                    $this->_helper->redirector("list");
                }
            }
        }
...
//            var_dump($formData);exit;
            ...
            $this->_helper->FlashMessenger->addMessage(array("error" => "It seems like this candidate has already processed."));
