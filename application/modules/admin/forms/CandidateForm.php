...
class Admin_Form_CandidateForm extends Zend_Form {
    ...
    public function init() {
        ...
        $p_issue_date->setLabel("Issued Date")
                ->setAttribs(array('class' => 'form-text', 'id' => 'passport_issued_date'))
                ->setRequired(true);

        $p_expiry_date = new Zend_Form_Element_Text("passport_expiry_date");
        $p_expiry_date->setLabel("Expiry Date")
                ->setAttribs(array('class' => 'form-text', 'id' => 'passport_expiry_date'))
                ->setRequired(true);
        ...
        $dob->setLabel("Date of Birth")
                ->setAttribs(array('size' => 30, 'class' => 'form-text', 'id' => 'dob'))
                ->setRequired(true);
