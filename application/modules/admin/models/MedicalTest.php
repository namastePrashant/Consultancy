...
class Admin_Model_MedicalTest {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Admin_Model_DbTable_MedicalTest');
        }
    ...
    public function getAllFail($where) {
        ...
        $select = $db->select();
        $select->from(array("ccan" => "consultancy_medical_test"), array("ccan.*"))
