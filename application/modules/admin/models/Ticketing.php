...
class Admin_Model_Ticketing {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Admin_Model_DbTable_Ticketing');
        }
    ...
    public function listAll() {
        ...
        $select = $db->select();
        $select->from(array("ur" => "consultancy_stamping"), array("ur.*"))
                ->joinLeft(array("c" => "consultancy_candidate"), "ur.candidate_id=c.candidate_id", array("c.name as candidate_name", "c.passport_no as passport_no", "c.company_name as company_name", "c.candidate_id as candidate_id"))
                ->joinLeft(array("m" => "consultancy_medical"), "c.candidate_id=m.candidate_id", array("m.visa_no as visa_no", "m.medical_center as medical_center", "m.id_number as id_no", "m.mofa_no as mofa_no", "m.gamca_no as gamca_no"))
                ->where("ur.del='N'");
